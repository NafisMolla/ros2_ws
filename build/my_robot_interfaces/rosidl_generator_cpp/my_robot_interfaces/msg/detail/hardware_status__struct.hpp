...
struct HardwareStatus_
{
  ...
  using _termperature_type =
    int64_t;
  _termperature_type termperature;
  ...
  Type & set__termperature(
    const int64_t & _arg)
  {
    this->termperature = _arg;
    return *this;
  }
  ...
  {
    if (this->termperature != other.termperature) {
      return false;
    }
