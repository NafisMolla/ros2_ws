...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // termperature
    PyObject * field = PyObject_GetAttrString(_pymsg, "termperature");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->termperature = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // are_motors_ready
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // termperature
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->termperature);
    {
      int rc = PyObject_SetAttrString(_pymessage, "termperature", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
