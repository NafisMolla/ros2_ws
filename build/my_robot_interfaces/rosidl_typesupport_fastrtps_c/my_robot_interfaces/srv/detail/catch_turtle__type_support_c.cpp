  ...
  void * untyped_ros_message)
{
  ...
  _CatchTurtle_Request__ros_msg_type * ros_message = static_cast<_CatchTurtle_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
{
  return max_serialized_size_my_robot_interfaces__srv__CatchTurtle_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_my_robot_interfaces__srv__CatchTurtle_Response(
    full_bounded, 0);
}
