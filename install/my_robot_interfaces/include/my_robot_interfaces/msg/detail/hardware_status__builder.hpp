...
class Init_HardwareStatus_termperature
{
public:
  Init_HardwareStatus_termperature()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_HardwareStatus_are_motors_ready termperature(::my_robot_interfaces::msg::HardwareStatus::_termperature_type arg)
  {
    msg_.termperature = std::move(arg);
...
{
  return my_robot_interfaces::msg::builder::Init_HardwareStatus_termperature();
}
