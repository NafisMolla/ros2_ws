...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.termperature = kwargs.get('termperature', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.termperature != other.termperature:
            return False
    ...
    @property
    def termperature(self):
        """Message field 'termperature'."""
        return self._termperature

    @termperature.setter
    def termperature(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'termperature' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'termperature' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._termperature = value
